...
1. If it's not still open, go to the Microsoft Copilot Studio portal and ensure you are in the appropriate environment.
...
1. In the **Details** section, turn Orchestration to **Enabled**. Select **Save**.
...
1. Select **Next** then **Add to agent**.

### Task 2.2 - Add knowledge from files

1. Download the **Microsoft case study** via the below link

    ```
    https://download.microsoft.com/documents/customerevidence/Files/4000007499/SummitRealtyCaseStudy.docx
    ```
...
1. Select **...** then select **System** tab and select **Activity.Text** for the **Input** field.
...
1. Select **Save** then **Save** again.

1. Select **Publish** then **Publish** again.
