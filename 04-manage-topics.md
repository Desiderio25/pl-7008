...
1. Navigate to the Microsoft Copilot Studio portal and ensure you are in the appropriate environment.
...
1. Select the agent you created in the previous lab, **Real Estate Booking Service**.
...
1. Select the **Copilot** icon to reopen the **Edit with Copilot** pane if it's not still there.
...
1. Select **Update**.A new question node is added to the end of the topic with options for the user to select.
