...
1. Select the **Environment** user account when prompted then **Allow**.
...
1. Click **...** then **Open agent flow**

1. Click **Edit** next to **Details**.
...
1. Enter your name and email when prompted.
